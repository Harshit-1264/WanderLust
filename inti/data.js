// sample data for initialize database
const sampleListings = [
  ...
  module.exports = { data: sampleListings };  //an array which we are exporting in the form of the object



// Another sample data for initialize database
